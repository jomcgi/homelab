...
export function ModelProviderTab({
  ...
  const [editingProviderIndex, setEditingProviderIndex] = useState<
    number | null
  >(null);
  const [initialProviderState, setInitialProviderState] =
    useState<RouterProvider | null>(null);
  ...
  const updateProvider = (index: number, updates: Partial<RouterProvider>) => {
    ...
    if (index === editingProviderIndex && initialProviderState) {
      ...
      const hasChanged =
        ...
        JSON.stringify(initialProviderState);
        ...
        <div className="py-4 border-b border-neutral-200 dark:border-neutral-800">
          <div className="flex items-center justify-between mb-3">
            ...
            <Tooltip>
              ...
              <TooltipContent>
                <p className="text-xs">
                  Select which model provider to use for conversations
                </p>
              </TooltipContent>
            </Tooltip>
          </div>
          ...
          <div className="flex gap-3">
            ...
            >
              ...
              <SelectContent>
                ...
                {localProviders
                  .filter(
                    (provider) => provider.name && provider.name.trim() !== "",
                  )
                  .map((provider) => (
                      ...
                      <div>
                        ...
                        >
                          ...
                          <Tooltip>
                            ...
                            <TooltipContent>
                              <p className="text-xs">
                                JSON array format, e.g., ["openrouter"]
                              </p>
                            </TooltipContent>
                          </Tooltip>
                        </Label>
              ...
              {!isJsonMode && (
                <div className="flex gap-2 justify-end">
                  ...
                  <Button
                    onClick={addProvider}
                    variant={
                      editingProviderIndex !== null ? "outline" : "default"
                    }
                    size="sm"
                    className="rounded-full"
                    disabled={editingProviderIndex !== null}
