  ...
  const handleWebPushToggle = async () => {
    ...
    try {
      ...
      if (error.message?.includes("Service Worker not supported")) {
        setWebPushError(
          "Service Worker not supported. Ensure you are using HTTPS or localhost.",
        );
        ...
        setWebPushError(
          "Server configuration issue. Please check server logs.",
        );
      } else if (
        ...
        setWebPushError(
          error.message || "Failed to enable web push notifications",
        );
      }
    } finally {
    ...
    <div className="px-6 pb-6 overflow-y-auto h-full">
      ...
      <div className="py-4 border-b border-neutral-200 dark:border-neutral-800">
        ...
        <p className="text-sm text-neutral-600 dark:text-neutral-400 mb-3">
          Ntfy works out of the box but opens notifications in the ntfy app. To
          receive push notifications, subscribe to the following{" "}
          <a
            href="https://ntfy.sh/"
            target="_blank"
      ...
      <div className="py-4">
              ...
              <div className="text-sm text-red-600 dark:text-red-400">
                ...
                {webPushError.includes("permission") && (
                  <p className="mt-2 text-xs">
                    Check your browser notification settings and allow
        ...
        {webPushStatus && !webPushStatus.hasPublicKey && (
          <div className="text-sm text-amber-600 dark:text-amber-400">
            ...
            Server VAPID keys not configured. Web Push will be auto-configured
            on first enable.
          </div>
        )}
      </div>
