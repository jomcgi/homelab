...
class ApiService {
  ...
  async getConversations(params?: {
    ...
    if (params?.projectPath)
      searchParams.append("projectPath", params.projectPath);
    ...
    if (params?.pinned !== undefined)
      searchParams.append("pinned", params.pinned.toString());
  ...
  async getPermissions(params?: {
    ...
    if (params?.streamingId)
      searchParams.append("streamingId", params.streamingId);
  ...
  async listDirectory(
    ...
    if (params.respectGitignore !== undefined)
      searchParams.append(
        "respectGitignore",
        params.respectGitignore.toString(),
      );
