...
export function createFileSystemRoutes(
  ...
  const parseBooleanParam = (
    ...
    throw new CUIError(
      "INVALID_PARAM",
      `${paramName} must be boolean (true/false)`,
      400,
    );
  };
  ...
  router.get(
    ...
    async (
      ...
      try {
        ...
        const recursive =
          parseBooleanParam(req.query.recursive, "recursive") ?? false;
        const respectGitignore =
          parseBooleanParam(req.query.respectGitignore, "respectGitignore") ??
          false;
