...
{{/*
Determine if Anthropic authentication is needed.
Auth is required for anthropic provider, optional for openai-compatible.
Returns "true" or "false" as string.
*/}}
{{- define "openclaw.authRequired" -}}
{{- if and .Values.auth.enabled (eq .Values.llm.provider "anthropic") }}
{{- "true" }}
{{- else }}
{{- "false" }}
{{- end }}
