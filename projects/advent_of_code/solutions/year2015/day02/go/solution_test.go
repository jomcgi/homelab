...
func loadAnswers(t *testing.T) *Answers {
	data, err := os.ReadFile("projects/advent_of_code/solutions/year2015/day02/answers.json")
	if err != nil {
...
func TestPart1(t *testing.T) {
	...
	input, err := aoc.ReadFile("projects/advent_of_code/solutions/year2015/day02/input.txt")
	if err != nil {
