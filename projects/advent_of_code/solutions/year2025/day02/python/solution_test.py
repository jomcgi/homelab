...
from projects.advent_of_code.solutions.year2025.day02.python.solution import (
    part1,
    part2,
)
...
def input_text():
    return Path(
        "projects/advent_of_code/solutions/year2025/day02/input.txt"
    ).read_text()


@pytest.fixture
def answers():
    answers_path = Path("projects/advent_of_code/solutions/year2025/day02/answers.json")
