...
def safe_database_operation(func: Callable[..., T]) -> Callable[..., Optional[T]]:
    """
...
def graceful_shutdown(func: Callable[..., T]) -> Callable[..., Optional[T]]:
    """
...
def handle_network_errors(func: Callable[..., T]) -> Callable[..., Optional[T]]:
    """
...
def with_error_collection(func: Callable[..., T]) -> Callable[..., tuple[Optional[T], ErrorCollector]]:
    """
    ...
    """
    @wraps(func)
    def wrapper(*args, **kwargs) -> tuple[Optional[T], ErrorCollector]:
