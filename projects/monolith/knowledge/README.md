...
Raw markdown is ingested, decomposed into structured facts by Gemma-4 (with self-critique for quality), embedded with voyage-4-nano, and stored in pgvector for semantic search. Fronted by a SvelteKit app with a `Cmd+K` search overlay.
...
| **gardener**        | Gemma-4 fact decomposition with self-critique and distillation |
