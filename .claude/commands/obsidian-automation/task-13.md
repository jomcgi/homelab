# obsidian-automation - Task 13

Execute task 13 for the obsidian-automation specification.

## Task Description
Create ServiceMonitor template in charts/obsidian-automation/templates/servicemonitor.yaml

## Code Reuse
**Leverage existing code**: ServiceMonitor patterns from existing services

## Requirements Reference
**Requirements**: 5.5, observability from tech.md

## Usage
```
/Task:13-obsidian-automation
```

## Instructions

Execute with @spec-task-executor agent the following task: "Create ServiceMonitor template in charts/obsidian-automation/templates/servicemonitor.yaml"

```
Use the @spec-task-executor agent to implement task 13: "Create ServiceMonitor template in charts/obsidian-automation/templates/servicemonitor.yaml" for the obsidian-automation specification and include all the below context.
...
## Task Details
- Task ID: 13
- Description: Create ServiceMonitor template in charts/obsidian-automation/templates/servicemonitor.yaml
- Leverage: ServiceMonitor patterns from existing services
- Requirements: 5.5, observability from tech.md

## Instructions
- Implement ONLY task 13: "Create ServiceMonitor template in charts/obsidian-automation/templates/servicemonitor.yaml"
- Follow all project conventions and leverage existing code
- Mark the task as complete using: claude-code-spec-workflow get-tasks obsidian-automation 13 --mode complete
...
```bash
claude-code-spec-workflow get-tasks obsidian-automation 13 --mode complete
```
