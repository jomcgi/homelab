# obsidian-automation - Task 4

Execute task 4 for the obsidian-automation specification.

## Task Description
Create OnePasswordItem template in charts/obsidian-automation/templates/onepassworditem.yaml

## Code Reuse
**Leverage existing code**: operators/cloudflare/helm/cloudflare-operator/examples/1password-secret.yaml
...
## Usage
```
/Task:4-obsidian-automation
```

## Instructions

Execute with @spec-task-executor agent the following task: "Create OnePasswordItem template in charts/obsidian-automation/templates/onepassworditem.yaml"

```
Use the @spec-task-executor agent to implement task 4: "Create OnePasswordItem template in charts/obsidian-automation/templates/onepassworditem.yaml" for the obsidian-automation specification and include all the below context.
...
## Task Details
- Task ID: 4
- Description: Create OnePasswordItem template in charts/obsidian-automation/templates/onepassworditem.yaml
- Leverage: operators/cloudflare/helm/cloudflare-operator/examples/1password-secret.yaml
- Requirements: 7.1, 7.2

## Instructions
- Implement ONLY task 4: "Create OnePasswordItem template in charts/obsidian-automation/templates/onepassworditem.yaml"
- Follow all project conventions and leverage existing code
- Mark the task as complete using: claude-code-spec-workflow get-tasks obsidian-automation 4 --mode complete
...
```bash
claude-code-spec-workflow get-tasks obsidian-automation 4 --mode complete
```
