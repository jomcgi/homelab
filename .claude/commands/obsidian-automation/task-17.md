# obsidian-automation - Task 17

Execute task 17 for the obsidian-automation specification.

## Task Description
Create ServiceAccount template in charts/obsidian-automation/templates/serviceaccount.yaml

## Code Reuse
**Leverage existing code**: ServiceAccount patterns from existing deployments
...
## Usage
```
/Task:17-obsidian-automation
```

## Instructions

Execute with @spec-task-executor agent the following task: "Create ServiceAccount template in charts/obsidian-automation/templates/serviceaccount.yaml"

```
Use the @spec-task-executor agent to implement task 17: "Create ServiceAccount template in charts/obsidian-automation/templates/serviceaccount.yaml" for the obsidian-automation specification and include all the below context.
...
## Task Details
- Task ID: 17
- Description: Create ServiceAccount template in charts/obsidian-automation/templates/serviceaccount.yaml
- Leverage: ServiceAccount patterns from existing deployments
- Requirements: 4.2

## Instructions
- Implement ONLY task 17: "Create ServiceAccount template in charts/obsidian-automation/templates/serviceaccount.yaml"
- Follow all project conventions and leverage existing code
- Mark the task as complete using: claude-code-spec-workflow get-tasks obsidian-automation 17 --mode complete
...
```bash
claude-code-spec-workflow get-tasks obsidian-automation 17 --mode complete
```
