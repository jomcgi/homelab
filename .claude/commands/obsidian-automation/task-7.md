# obsidian-automation - Task 7

Execute task 7 for the obsidian-automation specification.

## Task Description
c. Apply security context to Obsidian container in statefulset.yaml

## Code Reuse
**Leverage existing code**: security context from structure.md
...
## Usage
```
/Task:7-obsidian-automation
```

## Instructions

Execute with @spec-task-executor agent the following task: "c. Apply security context to Obsidian container in statefulset.yaml"

```
Use the @spec-task-executor agent to implement task 7: "c. Apply security context to Obsidian container in statefulset.yaml" for the obsidian-automation specification and include all the below context.
...
## Task Details
- Task ID: 7
- Description: c. Apply security context to Obsidian container in statefulset.yaml
- Leverage: security context from structure.md
- Requirements: 8.1, 8.2, 8.3, 8.4

## Instructions
- Implement ONLY task 7: "c. Apply security context to Obsidian container in statefulset.yaml"
- Follow all project conventions and leverage existing code
- Mark the task as complete using: claude-code-spec-workflow get-tasks obsidian-automation 7 --mode complete
...
```bash
claude-code-spec-workflow get-tasks obsidian-automation 7 --mode complete
```
