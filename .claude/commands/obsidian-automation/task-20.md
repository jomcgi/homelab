# obsidian-automation - Task 20

Execute task 20 for the obsidian-automation specification.

## Task Description
Create ArgoCD Application manifest in clusters/homelab/obsidian-automation/application.yaml

## Code Reuse
**Leverage existing code**: clusters/homelab/cloudflare-tunnel/application.yaml

## Requirements Reference
**Requirements**: GitOps deployment, automated management

## Usage
```
/Task:20-obsidian-automation
```

## Instructions

Execute with @spec-task-executor agent the following task: "Create ArgoCD Application manifest in clusters/homelab/obsidian-automation/application.yaml"

```
Use the @spec-task-executor agent to implement task 20: "Create ArgoCD Application manifest in clusters/homelab/obsidian-automation/application.yaml" for the obsidian-automation specification and include all the below context.
...
## Task Details
- Task ID: 20
- Description: Create ArgoCD Application manifest in clusters/homelab/obsidian-automation/application.yaml
- Leverage: clusters/homelab/cloudflare-tunnel/application.yaml
- Requirements: GitOps deployment, automated management

## Instructions
- Implement ONLY task 20: "Create ArgoCD Application manifest in clusters/homelab/obsidian-automation/application.yaml"
- Follow all project conventions and leverage existing code
- Mark the task as complete using: claude-code-spec-workflow get-tasks obsidian-automation 20 --mode complete
...
```bash
claude-code-spec-workflow get-tasks obsidian-automation 20 --mode complete
```
