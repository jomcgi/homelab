# obsidian-automation - Task 18

Execute task 18 for the obsidian-automation specification.

## Task Description
Create RBAC templates in charts/obsidian-automation/templates/rbac.yaml

## Code Reuse
**Leverage existing code**: RBAC patterns from operators/cloudflare

## Requirements Reference
**Requirements**: 4.2, security best practices

## Usage
```
/Task:18-obsidian-automation
```

## Instructions

Execute with @spec-task-executor agent the following task: "Create RBAC templates in charts/obsidian-automation/templates/rbac.yaml"

```
Use the @spec-task-executor agent to implement task 18: "Create RBAC templates in charts/obsidian-automation/templates/rbac.yaml" for the obsidian-automation specification and include all the below context.
...
## Task Details
- Task ID: 18
- Description: Create RBAC templates in charts/obsidian-automation/templates/rbac.yaml
- Leverage: RBAC patterns from operators/cloudflare
- Requirements: 4.2, security best practices

## Instructions
- Implement ONLY task 18: "Create RBAC templates in charts/obsidian-automation/templates/rbac.yaml"
- Follow all project conventions and leverage existing code
- Mark the task as complete using: claude-code-spec-workflow get-tasks obsidian-automation 18 --mode complete
...
```bash
claude-code-spec-workflow get-tasks obsidian-automation 18 --mode complete
```
