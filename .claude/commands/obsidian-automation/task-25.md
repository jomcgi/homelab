# obsidian-automation - Task 25

Execute task 25 for the obsidian-automation specification.

## Task Description
Create README.md with deployment and usage instructions

## Code Reuse
**Leverage existing code**: README patterns from existing charts

## Requirements Reference
**Requirements**: usability requirements, documentation standards

## Usage
```
/Task:25-obsidian-automation
```

## Instructions

Execute with @spec-task-executor agent the following task: "Create README.md with deployment and usage instructions"

```
Use the @spec-task-executor agent to implement task 25: "Create README.md with deployment and usage instructions" for the obsidian-automation specification and include all the below context.
...
## Task Details
- Task ID: 25
- Description: Create README.md with deployment and usage instructions
- Leverage: README patterns from existing charts
- Requirements: usability requirements, documentation standards

## Instructions
- Implement ONLY task 25: "Create README.md with deployment and usage instructions"
- Follow all project conventions and leverage existing code
- Mark the task as complete using: claude-code-spec-workflow get-tasks obsidian-automation 25 --mode complete
...
```bash
claude-code-spec-workflow get-tasks obsidian-automation 25 --mode complete
```
