# obsidian-automation - Task 10

Execute task 10 for the obsidian-automation specification.

## Task Description
Create NetworkPolicy template in charts/obsidian-automation/templates/networkpolicy.yaml

## Code Reuse
**Leverage existing code**: network policy patterns from security documentation
...
## Usage
```
/Task:10-obsidian-automation
```

## Instructions

Execute with @spec-task-executor agent the following task: "Create NetworkPolicy template in charts/obsidian-automation/templates/networkpolicy.yaml"

```
Use the @spec-task-executor agent to implement task 10: "Create NetworkPolicy template in charts/obsidian-automation/templates/networkpolicy.yaml" for the obsidian-automation specification and include all the below context.
...
## Task Details
- Task ID: 10
- Description: Create NetworkPolicy template in charts/obsidian-automation/templates/networkpolicy.yaml
- Leverage: network policy patterns from security documentation
- Requirements: 8.5, 8.6

## Instructions
- Implement ONLY task 10: "Create NetworkPolicy template in charts/obsidian-automation/templates/networkpolicy.yaml"
- Follow all project conventions and leverage existing code
- Mark the task as complete using: claude-code-spec-workflow get-tasks obsidian-automation 10 --mode complete
...
```bash
claude-code-spec-workflow get-tasks obsidian-automation 10 --mode complete
```
