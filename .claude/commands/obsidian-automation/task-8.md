# obsidian-automation - Task 8

Execute task 8 for the obsidian-automation specification.

## Task Description
c. Add health and readiness probes for sync monitor in statefulset.yaml

## Code Reuse
**Leverage existing code**: probe patterns from existing services
...
## Usage
```
/Task:8-obsidian-automation
```

## Instructions

Execute with @spec-task-executor agent the following task: "c. Add health and readiness probes for sync monitor in statefulset.yaml"

```
Use the @spec-task-executor agent to implement task 8: "c. Add health and readiness probes for sync monitor in statefulset.yaml" for the obsidian-automation specification and include all the below context.
...
## Task Details
- Task ID: 8
- Description: c. Add health and readiness probes for sync monitor in statefulset.yaml
- Leverage: probe patterns from existing services
- Requirements: 5.4, 6.1

## Instructions
- Implement ONLY task 8: "c. Add health and readiness probes for sync monitor in statefulset.yaml"
- Follow all project conventions and leverage existing code
- Mark the task as complete using: claude-code-spec-workflow get-tasks obsidian-automation 8 --mode complete
...
```bash
claude-code-spec-workflow get-tasks obsidian-automation 8 --mode complete
```
