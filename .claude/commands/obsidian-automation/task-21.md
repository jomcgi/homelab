# obsidian-automation - Task 21

Execute task 21 for the obsidian-automation specification.

## Task Description
Create production value overrides in clusters/homelab/obsidian-automation/values.yaml

## Code Reuse
**Leverage existing code**: clusters/homelab/cloudflare-tunnel/values.yaml

## Requirements Reference
**Requirements**: 9.1, 9.5, production deployment

## Usage
```
/Task:21-obsidian-automation
```

## Instructions

Execute with @spec-task-executor agent the following task: "Create production value overrides in clusters/homelab/obsidian-automation/values.yaml"

```
Use the @spec-task-executor agent to implement task 21: "Create production value overrides in clusters/homelab/obsidian-automation/values.yaml" for the obsidian-automation specification and include all the below context.
...
## Task Details
- Task ID: 21
- Description: Create production value overrides in clusters/homelab/obsidian-automation/values.yaml
- Leverage: clusters/homelab/cloudflare-tunnel/values.yaml
- Requirements: 9.1, 9.5, production deployment

## Instructions
- Implement ONLY task 21: "Create production value overrides in clusters/homelab/obsidian-automation/values.yaml"
- Follow all project conventions and leverage existing code
- Mark the task as complete using: claude-code-spec-workflow get-tasks obsidian-automation 21 --mode complete
...
```bash
claude-code-spec-workflow get-tasks obsidian-automation 21 --mode complete
```
