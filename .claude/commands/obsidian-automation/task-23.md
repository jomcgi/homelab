# obsidian-automation - Task 23

Execute task 23 for the obsidian-automation specification.

## Task Description
Create GitHub Actions workflow in .github/workflows/obsidian-automation.yml

## Code Reuse
**Leverage existing code**: existing GitHub Actions workflows

## Requirements Reference
**Requirements**: CI/CD automation, container registry

## Usage
```
/Task:23-obsidian-automation
```

## Instructions

Execute with @spec-task-executor agent the following task: "Create GitHub Actions workflow in .github/workflows/obsidian-automation.yml"

```
Use the @spec-task-executor agent to implement task 23: "Create GitHub Actions workflow in .github/workflows/obsidian-automation.yml" for the obsidian-automation specification and include all the below context.
...
## Task Details
- Task ID: 23
- Description: Create GitHub Actions workflow in .github/workflows/obsidian-automation.yml
- Leverage: existing GitHub Actions workflows
- Requirements: CI/CD automation, container registry

## Instructions
- Implement ONLY task 23: "Create GitHub Actions workflow in .github/workflows/obsidian-automation.yml"
- Follow all project conventions and leverage existing code
- Mark the task as complete using: claude-code-spec-workflow get-tasks obsidian-automation 23 --mode complete
...
```bash
claude-code-spec-workflow get-tasks obsidian-automation 23 --mode complete
```
