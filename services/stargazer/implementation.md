...
- [ ] **T4**: Download SRTM DEM → `data/raw/srtm_tiles/` *(placeholder - needs SRTM tile fetching)*
...
- [ ] **T8**: Clip DEM to Bounds → `data/processed/scotland-dem.tif` *(placeholder - depends on T4)*
