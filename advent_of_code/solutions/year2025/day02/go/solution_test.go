...
import (
	...
	"github.com/jomcgi/homelab/advent_of_code/pkg/aoc"
)
...
func loadAnswers(t *testing.T) *Answers {
	data, err := os.ReadFile("advent_of_code/solutions/year2025/day02/answers.json")
	if err != nil {
...
func TestPart1(t *testing.T) {
	...
	input, err := aoc.ReadFile("advent_of_code/solutions/year2025/day02/input.txt")
	if err != nil {
