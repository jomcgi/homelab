...
from advent_of_code.solutions.year2015.day02.python.solution import part1, part2


@pytest.fixture
def input_text():
    return Path("advent_of_code/solutions/year2015/day02/input.txt").read_text()


@pytest.fixture
def answers():
    answers_path = Path("advent_of_code/solutions/year2015/day02/answers.json")
